...
../../../pdfsak --input-file ../../input/presentation.pdf --output ../../output/handout2x2_W.pdf --add-white-pages

../../../pdfsak --input-file ../../output/handout2x2_W.pdf --output ../../output/handout2x2.pdf --nup 2 2 --height 0.32 --landscape --frame --paper a4paper
